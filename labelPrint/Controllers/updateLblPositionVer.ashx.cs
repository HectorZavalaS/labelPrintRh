...
{
    /// <summary>
    /// Descripción breve de updateLblPositionVer
    /// </summary>
    public class updateLblPositionVer : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                int result = m_db.updateLblPositionVert(idModel,idUser, value).First().RESULT;
                if (result == 1)
                    json += "\"result\":\"true\"";
                else
                {
