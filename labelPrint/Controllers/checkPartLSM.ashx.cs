...
{
    /// <summary>
    /// Descripción breve de checkPartLSM
    /// </summary>
    public class checkPartLSM : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                var result = m_db.checkPartLSM(id_model, djGroup.ToString(), pcbQty, id_flx, id_color, id_vol).First();
