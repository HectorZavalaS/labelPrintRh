...
{
    /// <summary>
    /// Descripción breve de checkPartM
    /// </summary>
    public class checkPartM : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                var result = m_db.checkPartM(id_model,djGroup.ToString(), pcbQty, id_flx,id_color,id_vol).First();
