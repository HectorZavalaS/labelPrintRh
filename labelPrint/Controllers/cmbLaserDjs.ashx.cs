...
{
    /// <summary>
    /// Descripción breve de cmbLaserDjs
    /// </summary>
    public class cmbLaserDjs : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                var AllModels = m_db.getLaserDjs(datIni, datFin).ToList();
                foreach (getLaserDjs_Result row in AllModels)
                {
                    if(row.ASSEMBLY_DESC.Contains("FCA"))
