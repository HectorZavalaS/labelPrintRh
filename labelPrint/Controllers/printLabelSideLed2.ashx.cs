...
{
    /// <summary>
    /// Summary description for printLabelSideLed2
    /// </summary>
    public class printLabelSideLed2 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                template_codeL = m_db.generate_lblCode_templateLed2(id_model, id_side, id_flx, id_vol, id_rev, id_color, fechaDJ, id_flx1, id_vol1, id_color1).First();

                json = m_zpl2.sendLRSidesToPrinterV2(template_codeL, num_lbls, ref result, f, c, v, ref folios, is_rem, fechaDJ, id_printer, djGrp, type_print, id_side);
                if (type_print == "FOLIO")
