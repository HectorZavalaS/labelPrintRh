...
{
    public class siixsem_sidesModelController : Controller
    {
        private siixsem_main_dbEntities db = new siixsem_main_dbEntities();

        // GET: siixsem_sidesModel
        ...
        // GET: siixsem_sidesModel/Details/5
        ...
        // POST: siixsem_sidesModel/Create
        ...
        // POST: siixsem_sidesModel/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: siixsem_sidesModel/Delete/5
        ...
        // POST: siixsem_sidesModel/Delete/5
