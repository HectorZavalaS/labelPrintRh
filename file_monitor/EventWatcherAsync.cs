...
namespace file_monitor
{
    public class EventWatcherAsync
    {
        ...
        public bool ResultConnect { get => resultConnect; set => resultConnect = value; }
        public string ErrorMessage { get => m_errorMessage; set => m_errorMessage = value; }
        ...
        public EventWatcherAsync(String IP, String tgDrive, String tgPath)
        {
            ...
            catch (Exception e)
            {
                ...
                m_errorMessage = e.Message.Replace("\r\n","");
                resultConnect = false;
            }
